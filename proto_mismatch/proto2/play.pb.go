...
type PlayReq2 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	A    string `protobuf:"bytes,1,opt,name=A,json=a,proto3" json:"A,omitempty"`
	Cat  string `protobuf:"bytes,2,opt,name=Cat,json=cat,proto3" json:"Cat,omitempty"`
	Nums int64  `protobuf:"varint,3,opt,name=Nums,json=nums,proto3" json:"Nums,omitempty"`
}

func (x *PlayReq2) Reset() {
	*x = PlayReq2{}
...
func (x *PlayReq2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlayReq2) ProtoMessage() {}

func (x *PlayReq2) ProtoReflect() protoreflect.Message {
	mi := &file_play_proto_msgTypes[0]
...
// Deprecated: Use PlayReq2.ProtoReflect.Descriptor instead.
func (*PlayReq2) Descriptor() ([]byte, []int) {
	return file_play_proto_rawDescGZIP(), []int{0}
}

func (x *PlayReq2) GetA() string {
	if x != nil {
		return x.A
	}
	return ""
...
var file_play_proto_rawDesc = []byte{
	...
	,
}
...
var file_play_proto_goTypes = []interface{}{
	(*PlayReq2)(nil), // 0: api.PlayReq2
	(*PlayRes)(nil),  // 1: api.PlayRes
	(*StopReq)(nil),  // 2: api.StopReq
	(*StopRes)(nil),  // 3: api.StopRes
}
var file_play_proto_depIdxs = []int32{
	0, // 0: api.PlaySvc.Play:input_type -> api.PlayReq2
	2, // 1: api.PlaySvc.Stop2:input_type -> api.StopReq
	1, // 2: api.PlaySvc.Play:output_type -> api.PlayRes
	3, // 3: api.PlaySvc.Stop2:output_type -> api.StopRes
...
type PlaySvcClient interface {
	Play(ctx context.Context, in *PlayReq2, opts ...grpc.CallOption) (*PlayRes, error)
	Stop2(ctx context.Context, in *StopReq, opts ...grpc.CallOption) (*StopRes, error)
}
...
func (c *playSvcClient) Play(ctx context.Context, in *PlayReq2, opts ...grpc.CallOption) (*PlayRes, error) {
	out := new(PlayRes)
	fmt.Println("play-->in", in)
	err := c.cc.Invoke(ctx, "/api.PlaySvc/Play", in, out, opts...)
	fmt.Println("play-->out", out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playSvcClient) Stop2(ctx context.Context, in *StopReq, opts ...grpc.CallOption) (*StopRes, error) {
	out := new(StopRes)
	fmt.Println("stop-->", in)
	err := c.cc.Invoke(ctx, "/api.PlaySvc/Stop2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlaySvcServer interface {
	Play(context.Context, *PlayReq2) (*PlayRes, error)
	Stop2(context.Context, *StopReq) (*StopRes, error)
}
...
func (*UnimplementedPlaySvcServer) Play(context.Context, *PlayReq2) (*PlayRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Play not implemented")
}
func (*UnimplementedPlaySvcServer) Stop2(context.Context, *StopReq) (*StopRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Stop2 not implemented")
}
...
func _PlaySvc_Play_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaySvcServer).Play(ctx, req.(*PlayReq2))
	}
	return interceptor(ctx, in, info, handler)
}

func _PlaySvc_Stop2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StopReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlaySvcServer).Stop2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.PlaySvc/Stop2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaySvcServer).Stop2(ctx, req.(*StopReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PlaySvc_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Stop2",
			Handler:    _PlaySvc_Stop2_Handler,
		},
	},
