...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x94, 0x02, 0x0a, 0x07, 0x47,
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x09, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x43, 0x12, 0x18, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64,
	...
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x28, 0x01, 0x12, 0x41, 0x0a, 0x09, 0x53, 0x61, 0x79,
	0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x12, 0x18, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f,
	...
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x30, 0x01, 0x12, 0x43, 0x0a, 0x09,
	0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x42, 0x12, 0x18, 0x2e, 0x68, 0x65, 0x6c, 0x6c,
...
var file_helloworld_proto_depIdxs = []int32{
	...
	0, // 1: helloworld.Greeter.SayHelloC:input_type -> helloworld.HelloRequest
	0, // 2: helloworld.Greeter.SayHelloS:input_type -> helloworld.HelloRequest
	0, // 3: helloworld.Greeter.SayHelloB:input_type -> helloworld.HelloRequest
	1, // 4: helloworld.Greeter.SayHello:output_type -> helloworld.HelloReply
	1, // 5: helloworld.Greeter.SayHelloC:output_type -> helloworld.HelloReply
	1, // 6: helloworld.Greeter.SayHelloS:output_type -> helloworld.HelloReply
	1, // 7: helloworld.Greeter.SayHelloB:output_type -> helloworld.HelloReply
...
type GreeterClient interface {
	...
	SayHelloC(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloCClient, error)
	// server-side streaming RPC
	SayHelloS(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayHelloSClient, error)
	// bidirectional streaming RPC
	SayHelloB(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloBClient, error)
}
...
func (c *greeterClient) SayHelloC(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloCClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/helloworld.Greeter/SayHelloC", opts...)
	if err != nil {
		return nil, err
	}
	x := &greeterSayHelloCClient{stream}
	return x, nil
}

type Greeter_SayHelloCClient interface {
	Send(*HelloRequest) error
	CloseAndRecv() (*HelloReply, error)
	grpc.ClientStream
}

type greeterSayHelloCClient struct {
	grpc.ClientStream
}

func (x *greeterSayHelloCClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterSayHelloCClient) CloseAndRecv() (*HelloReply, error) {
...
func (c *greeterClient) SayHelloS(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayHelloSClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[1], "/helloworld.Greeter/SayHelloS", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayHelloB(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloBClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[2], "/helloworld.Greeter/SayHelloB", opts...)
	if err != nil {
		return nil, err
	}
	x := &greeterSayHelloBClient{stream}
	return x, nil
}

type Greeter_SayHelloBClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloReply, error)
	grpc.ClientStream
}

type greeterSayHelloBClient struct {
	grpc.ClientStream
}

func (x *greeterSayHelloBClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterSayHelloBClient) Recv() (*HelloReply, error) {
	m := new(HelloReply)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreeterServer interface {
	...
	// client-side streaming RPC
	SayHelloC(Greeter_SayHelloCServer) error
	// server-side streaming RPC
	SayHelloS(*HelloRequest, Greeter_SayHelloSServer) error
	// bidirectional streaming RPC
	SayHelloB(Greeter_SayHelloBServer) error
}
...
func (*UnimplementedGreeterServer) SayHelloC(Greeter_SayHelloCServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloC not implemented")
}
...
func (*UnimplementedGreeterServer) SayHelloB(Greeter_SayHelloBServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloB not implemented")
}
...
func _Greeter_SayHelloC_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).SayHelloC(&greeterSayHelloCServer{stream})
}

type Greeter_SayHelloCServer interface {
	SendAndClose(*HelloReply) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greeterSayHelloCServer struct {
	grpc.ServerStream
}

func (x *greeterSayHelloCServer) SendAndClose(m *HelloReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterSayHelloCServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
...
func _Greeter_SayHelloB_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).SayHelloB(&greeterSayHelloBServer{stream})
}

type Greeter_SayHelloBServer interface {
	Send(*HelloReply) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greeterSayHelloBServer struct {
	grpc.ServerStream
}

func (x *greeterSayHelloBServer) Send(m *HelloReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterSayHelloBServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SayHelloC",
			Handler:       _Greeter_SayHelloC_Handler,
			ClientStreams: true,
		},
		{
		...
		{
			StreamName:    "SayHelloB",
			Handler:       _Greeter_SayHelloB_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
